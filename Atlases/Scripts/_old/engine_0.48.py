...
spawner_box_zone = SpawnerBoxZone(225, 200, 24, 24, PURPLE, PURPLE, spawn_cooldown=2500, initial_spawn_delay=2500)
spawner_box_zone.set_parameters(velocity_x=325, velocity_y=325, mass=6, angle=45)
...
while running:
    ...
    # Spawn pucks from SpawnerBox
    spawner_box_zone.spawn_puck(pucks, dt)
    ...
    # Draw SpawnerBox
    pygame.draw.rect(screen, PURPLE, spawner_box_zone.rect, 2)
