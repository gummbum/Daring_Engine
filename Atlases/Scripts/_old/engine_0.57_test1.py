...
class SpawnerBox:
    ...
    # TODO: Add support for spawning ice_cubes or pucks based on parameter input when it is instantiated.
...
spawner_box_zone8 = SpawnerBox(450, 288, 24, 24, PURPLE, PURPLE, spawn_cooldown=500, initial_spawn_delay=1750)
spawner_box_zone8.set_parameters(velocity_x=200, velocity_y=200, mass=6, angle=-49)
...
spawner_boxes = [spawner_box_zone1, spawner_box_zone2, spawner_box_zone3, spawner_box_zone4, spawner_box_zone5, spawner_box_zone6
                 , spawner_box_zone7, spawner_box_zone8]
...
while running:
    ...
    pygame.draw.rect(screen, PURPLE, spawner_box_zone8.rect, 2)
