...
spawner_box_zone4.set_parameters(velocity_x=100, velocity_y=100, mass=6, angle=360)
...
spawner_boxes = [spawner_box_zone1, spawner_box_zone2, spawner_box_zone3, spawner_box_zone4, spawner_box_zone5]

friction_zone = FrictionZone(100, 50, 200, 150, 0.965)
kill_box = KillBox(8, 468, 124, 124)
booster = Booster(600, 0, 32, 600, 6.25)
magnet = Magnet(300, 400, 50, 0.12, 0.5, 10.0)
